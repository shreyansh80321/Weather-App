...
const App = () => {
  //aae4863fa3e7003c0bf3c33d8811ce83
  //https://api.openweathermap.org/data/2.5/weather?lat=${s.lat}&lon=${s.lon}.15&appid={API_KEY}&units=metric
  //https://api.openweathermap.org/data/2.5/weather?q={city name}&appid=${API_KEY}&units=metric

  //http://api.openweathermap.org/geo/1.0/direct?q={query}&limit=5&appid={API_KEY}

  const API_KEY = "aae4863fa3e7003c0bf3c33d8811ce83";
          ...
          {!weather ? (
            <form onSubmit={handleSearch} className="flex flex-col relative">
              <input
                ...
                className="mb-3 p-3 rounded border border-white bg-transparent text-white placeholder-white focus:outline-none focus:border-blue-300 transition duration-300"
              />
              {suggestion.length > 0 && (
              ...
              <button
                type="submit"
                className="bg-purple-700 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded transition-colors"
              >
                Get Weather
              </button>
            </form>
            ...
            <div className="mt-6 text-center transition-opacity duration-500">
              ...
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="bg-blue-700 text-white hover:bg-blue-800 font-semibold py-1 px-3 rounded transition-colors"
                >
                  &deg;{unit}
                </button>
              </div>
